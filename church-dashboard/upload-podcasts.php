                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                       <div class="profile-info">  
                           <form action="">
                                <div class="row">
                                    <h5 class="edit-hd">Podcast Details</h5>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="edit-box  textarea">
                                            ...
                                            <div class="input-box form-control">
                                                <textarea name="" id="" rows="2" placeholder="Write a short description about this podcast"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="input-side">
                                             <div class="edit-box">
                                                <h6 class="label">Podcast Thumbnail *</h6>
                                                <div class="input-box form-control">
                                                    <input type="file" required>
                                                </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-btns">
                                            <button type="submit" class="theme-btn primary"> Publish Podcast</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
